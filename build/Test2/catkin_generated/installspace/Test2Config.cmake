...
if("FALSE" STREQUAL "TRUE")
  set(Test2_SOURCE_PREFIX /home/ghost/catkin_ws/src/Test2)
  set(Test2_DEVEL_PREFIX /home/ghost/catkin_ws/devel)
  set(Test2_INSTALL_PREFIX "")
  set(Test2_PREFIX ${Test2_DEVEL_PREFIX})
else()
  set(Test2_SOURCE_PREFIX "")
  set(Test2_DEVEL_PREFIX "")
  set(Test2_INSTALL_PREFIX /home/ghost/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'Test2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Charles West <crwest@ncsu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'Test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ghost/catkin_ws/install/${idir}'.  Ask the maintainer 'Charles West <crwest@ncsu.edu>' to fix it.")
    endif()
