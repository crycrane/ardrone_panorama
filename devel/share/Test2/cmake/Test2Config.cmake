...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'Test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ghost/catkin_ws/src/Test2/${idir}'.  Ask the maintainer 'Charles West <crwest@ncsu.edu>' to fix it.")
    endif()
